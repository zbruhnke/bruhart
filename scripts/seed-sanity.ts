...
const siteSettings = {
  ...
  mainNavigation: [
    ...
    { _key: 'nav2', name: 'Products', href: '/products', children: [
      ...
      { _key: 'nav2b', name: 'Bollards & Barriers', href: '/products#bollards' },
      { _key: 'nav2c', name: 'Security Fencing', href: '/products#security-fencing' },
      { _key: 'nav2d', name: 'Access Control', href: '/products#access-control' },
      { _key: 'nav2e', name: 'Barrier Arms', href: '/products#barrier-arms' },
      { _key: 'nav2f', name: 'Gate Operators', href: '/products#operators' },
    ]},
