    ...
    (
      <div
        style={{
          ...
          padding: '60px',
          fontFamily: 'Inter',
          backgroundImage: `linear-gradient(135deg, rgba(15, 39, 68, 0.92) 0%, rgba(30, 58, 95, 0.88) 50%, rgba(45, 74, 111, 0.85) 100%), url(${getBaseUrl()}/images/bruhart_work/IMG_4252.jpeg)`,
