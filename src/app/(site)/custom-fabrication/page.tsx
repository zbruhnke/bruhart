        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-3xl mx-auto mb-12">
            ...
            <p className="text-lg text-foreground-muted">
              ...
              from the ground up to work together. That means easier installer coordination,
              smoother operation, and customers who come back for their next project.
            </p>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="bg-white rounded-xl p-8 border border-border text-center">
              ...
              <h3 className="text-lg font-semibold text-foreground mb-2">Easier Installer Coordination</h3>
              <p className="text-sm text-foreground-muted">
                Components designed to fit together can mean less time for the installer to spend adjusting and troubleshooting.
              </p>
            </div>
