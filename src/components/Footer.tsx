      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="py-16 grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-8">
          ...
          <div className="col-span-2">
            ...
            <div className="flex gap-4">
              <a href="#" className="text-steel-light hover:text-white transition-colors">
        ...
        <div className="py-8 border-t border-white/10">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="flex items-center gap-3">
              ...
              <span className="text-steel-light text-sm">7111 US Hwy 27, Branford, FL 32008</span>
            </div>
            <div className="flex items-center gap-3">
              <svg className="w-5 h-5 text-accent" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" />
              </svg>
              <a href="tel:+1-318-344-5731" className="text-steel-light hover:text-white transition-colors text-sm">
                (318) 344-5731
              </a>
            </div>
            <div className="flex items-center gap-3">
              ...
              <a href="mailto:info@bruhart.com" className="text-steel-light hover:text-white transition-colors text-sm">
                info@bruhart.com
              </a>
            </div>
          </div>
        ...
        <div className="py-6 border-t border-white/10 flex flex-col md:flex-row justify-between items-center gap-4">
          <p className="text-steel-light text-sm">
            © {new Date().getFullYear()} Bru-Hart Industries. All rights reserved.
          </p>
